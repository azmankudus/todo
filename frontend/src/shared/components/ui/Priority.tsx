...
export const PRIORITIES = [
  { value: 1, label: RESOURCES.PRIORITY.P1, short: RESOURCES.PRIORITY.P1_SHORT, colorClass: "bg-red-500" },
  { value: 2, label: RESOURCES.PRIORITY.P2, short: RESOURCES.PRIORITY.P2_SHORT, colorClass: "bg-amber-500" },
  { value: 3, label: RESOURCES.PRIORITY.P3, short: RESOURCES.PRIORITY.P3_SHORT, colorClass: "bg-yellow-400" },
  { value: 4, label: RESOURCES.PRIORITY.P4, short: RESOURCES.PRIORITY.P4_SHORT, colorClass: "bg-green-500" },
  { value: 5, label: RESOURCES.PRIORITY.P5, short: RESOURCES.PRIORITY.P5_SHORT, colorClass: "bg-blue-500" },
];

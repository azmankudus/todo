      ...
      <nav class="relative max-w-7xl w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8">
        <div class="flex items-center justify-between">
          <A class="flex items-center gap-x-2.5 font-black text-slate-900 dark:text-white group/brand transition-all duration-300" href="/" aria-label="Brand">
            ...
            <span class="text-2xl tracking-tight transition-all duration-300 group-hover/brand:[text-shadow:0_0_12px_rgba(99,102,241,0.7)] whitespace-nowrap">{local.brand || "Todo"}</span>
          </A>
          <div class="sm:hidden flex items-center gap-x-1">
            <ThemeDropdown
              type="bg"
              title={RESOURCES.THEME.BG_PATTERN}
            ...
            <ThemeDropdown
              type="color"
              title={RESOURCES.THEME.COLOR_THEME}
            ...
            <IconButton
              ...
              variant="primary"
              glow
              title={isWideMode() ? RESOURCES.THEME.CENTERED_VIEW : RESOURCES.THEME.WIDE_VIEW}
            ...
            <IconButton
              ...
              variant="primary"
              glow
              title={local.theme === "dark" ? RESOURCES.THEME.SWITCH_TO_LIGHT : RESOURCES.THEME.SWITCH_TO_DARK}
            />
            <IconButton
              ...
              <Show when={local.user} fallback={
                ...
                <div class="flex items-center gap-3">
                  ...
                  <TextButton
                    ...
                    onClick={() => logout()}
                    title={RESOURCES.COMMON.SIGN_OUT}

          ...
          >
            ...
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-slate-700">
              <h3 class="text-lg font-bold text-gray-900 dark:text-white flex items-center gap-2">
                {props.icon || <TableProperties size={20} class="text-primary-600 dark:text-primary-400" />}
                {props.title || 'Row Detail'}
                <Show when={props.rowNum}>
                  <span class="text-sm font-mono px-2.5 py-1 rounded-lg bg-primary-100 dark:bg-primary-900/30 text-primary-700 dark:text-primary-300">#{props.rowNum}</span>
                </Show>
              </h3>
              <button
